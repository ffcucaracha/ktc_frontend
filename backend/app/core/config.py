...
class Settings(BaseSettings):
    ...
    simulation_api_base_url: str = Field(default="http://simulation-service:8080", validation_alias="SIMULATION_API_BASE_URL")
    simulation_ws_base_url: str = Field(default="ws://simulation-service:8080", validation_alias="SIMULATION_WS_BASE_URL")
    simulation_api_key: str = Field(default="change-me", validation_alias="SIMULATION_API_KEY")
    ktc_api_base_url: str = Field(default="http://localhost:8001", validation_alias="KTC_API_BASE_URL")
    simulation_connect_timeout_seconds: float = Field(default=3.0, validation_alias="SIMULATION_CONNECT_TIMEOUT_SECONDS")
    simulation_read_timeout_seconds: float = Field(default=10.0, validation_alias="SIMULATION_READ_TIMEOUT_SECONDS")
    simulation_telemetry_enabled: bool = Field(default=True, validation_alias="SIMULATION_TELEMETRY_ENABLED")
    simulation_telemetry_interval_seconds: float = Field(default=2.0, gt=0, validation_alias="SIMULATION_TELEMETRY_INTERVAL_SECONDS")
    simulation_telemetry_discovery_interval_seconds: float = Field(default=1.0, gt=0, validation_alias="SIMULATION_TELEMETRY_DISCOVERY_INTERVAL_SECONDS")
    ...
    ai_read_timeout_seconds: float = Field(default=15.0, gt=0, validation_alias="AI_READ_TIMEOUT_SECONDS")
    ai_prediction_timeout_seconds: float = Field(default=0.8, gt=0, validation_alias="AI_PREDICTION_TIMEOUT_SECONDS")
